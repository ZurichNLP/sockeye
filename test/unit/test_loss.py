...
def test_custom_cross_entropy_loss(logits_np, labels_np, weights_np, expected_arguments, expected_softmax,
                                   expected_loss, expected_grads, label_smoothing, use_instance_weight):
    run_test_custom_cross_entropy_loss(logits_np, labels_np, weights_np, expected_arguments, expected_softmax,
                                   expected_loss, expected_grads, label_smoothing, use_instance_weight)
