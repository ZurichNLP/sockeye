...
ATTENTION_MONOTONICITY_LOSS = "attention-monotonicity"
ATTENTION_MONOTONICITY_LOSS_LAYER_LAST = "last"
ATTENTION_MONOTONICITY_LOSS_LAYER_ALL = "all"
ATTENTION_MONOTONICITY_LOSS_LAYERS = [ATTENTION_MONOTONICITY_LOSS_LAYER_ALL, ATTENTION_MONOTONICITY_LOSS_LAYER_LAST]
