...
INSTANCE_WEIGHT_NAME = "instance-weight"
...
TRAINING_ARG_INSTANCE_WEIGHTING = "--instance-weighting"
TRAINING_ARG_INSTANCE_WEIGHTS_FILE = "--instance-weights-file"

INSTANCE_WEIGHTING_TYPE_WORD = "word"
INSTANCE_WEIGHTING_TYPE_SENTENCE = "sentence"

INSTANCE_WEIGHTING_TYPES = [INSTANCE_WEIGHTING_TYPE_WORD,
                            INSTANCE_WEIGHTING_TYPE_SENTENCE]
...
SHARD_WEIGHT = SHARD_NAME + ".weight"
DATA_INFO = "data.info"
