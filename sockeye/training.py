...
class TrainingModel(model.SockeyeModel):
    ...
    def __init__(self,
                 ...
                 monotonicity_on_first_n_heads: Optional[int] = -1) -> None:
        ...
        self._monotonicity_on_first_n_heads = monotonicity_on_first_n_heads
            ...
            if self._attention_monotonicity is not None:
                ...
                if self._attention_monotonicity == "learned":
                    loss_attention= [self.attention_monotonicity_loss.get_loss(attention_scores_list=attention_scores_list,
                                                                                    ...
                                                                                    monotonicity_on_first_n_heads=self._monotonicity_on_first_n_heads,
    ...
    def fit(self,
        ...
        while True:
            ...
            if max_samples is not None and self.state.samples >= max_samples:
                logger.info("Maximum # of sam_positional_attention_loss_marginples (%s) reached", max_samples)
                break
